  ...
  <div class="navbar bg-base-100">
        ...
        >
          ...
          <li>
            ...
            <ul class="p-2">
              ...
              <li><NuxtLink to="/tutor/work">Work</NuxtLink></li>
            </ul>
          </li>
          <li>
            ...
            <ul class="p-2">
              ...
              <li><NuxtLink to="/teacher/work">Work</NuxtLink></li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <div class="navbar-center hidden lg:flex">
      <ul class="menu menu-horizontal px-1">
        <!-- <li><NuxtLink to="/admin/home">Home</NuxtLink></li> -->
        <!-- <li> -->
        <!--   <details> -->
        <!--     <summary>Parent</summa
        <!--     <ul class="p-2"> -->
        ...
        <!--   </details> -->
        <!-- </li> -->
        <!-- <li><StudentNuxtLink to="/admin/work">Work</NuxtLink></li> -->
        <li>
          <details>
    ...
    <div class="navbar-end">
      <button v-if="user" clbuttonss="btn" @click="signOut">Sign Out</button>
    </div>
  </div>
</template>
